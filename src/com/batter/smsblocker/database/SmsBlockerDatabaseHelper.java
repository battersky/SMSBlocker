...
public class SmsBlockerDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_TABLE_NAME_SMS_BLOCKER_LIST = "sms_blocker_list";
    public static final String DATABASE_TABLE_NAME_SMS_BLOCKER_HISTORY = "sms_blocker_history";
